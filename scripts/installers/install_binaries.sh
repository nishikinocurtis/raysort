...
install_prometheus() {
    _install_github_binary prometheus prometheus 2.46.0 .
}

install_node_exporter() {
    _install_github_binary prometheus node_exporter 1.6.1 .
}

install_jaeger() {
    _install_github_binary jaegertracing jaeger 1.48.0 -
}
