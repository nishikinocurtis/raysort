...
class AppConfig:
    ...
    merge_threshold_gb: int = 1  # max size of a merger output chunk
    # if a reducer's input exceeds this threshold the input will be streamed
    streaming_reducer_threshold_gb: int = field(init=True, default=8)
